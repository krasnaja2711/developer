...
<nav>
    <div class="nav-wrapper">
        <div class="col s12">
            ...
            <a href="/blog/add/" class="breadcrumb">Добавить новость</a>
        </div>
    </div>
</nav>
...
{% for item in page.items %}
    ...
    <div class="card">
        ...
        <div class="card-action">
            ...
            <a href="/blog/edit/{{ item.getUrl() }}"><i class="material-icons">mode_edit</i></a>
            <a href="/blog/del/{{ item.getUrl() }}"><i class="material-icons">delete</i></a>
